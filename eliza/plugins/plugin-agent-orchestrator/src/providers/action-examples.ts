...
export const codingAgentExamplesProvider: Provider = {
  ...
  get: async (runtime: IAgentRuntime, message: Memory, _state: State) => {
    ...
    const detailedText = [
      compactText,
      "",
      "examples[6]{user,actions,params}:",
      ...
      "  Any connected channel asks build me a small app and send a live preview URL,REPLY|CREATE_TASK,task=Build the app end to end run relevant checks start an ngrok public preview and send the publicUrl back to the originating thread with progress updates",
      ...
      "  channelBuilds: acknowledge first, then CREATE_TASK, progress updates, final live preview URL in the originating thread",
