...
If the request asks for people in the room/channel/group, use the provided room, identity, relationship, and recent-message context to create a group scene. Make visual personality assumptions from observed behavior and writing style, but do not assert unverified real-world identities.
...
- when the user asks to generate, create, draw, render, illustrate, or design an image, picture, poster, caricature, meme, banner, or other visual, choose GENERATE_IMAGE and include a prompt param instead of replying in prose only
...
If the user asks to generate, create, draw, render, illustrate, or design an image, picture, poster, caricature, meme, banner, or other visual, choose GENERATE_IMAGE with a prompt param.
